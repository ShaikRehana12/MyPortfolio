...
function App() {
  ...
  useEffect(() => {
    // Force document root to always stay dark
    document.documentElement.classList.add('dark');
  }, []);
  ...
  return (
    <div className="dark">
      <div className="min-h-screen bg-[#020408] text-slate-100 flex flex-col relative font-sans selection:bg-cyan-500 selection:text-slate-950 animate-fadeIn transition-colors duration-500">
